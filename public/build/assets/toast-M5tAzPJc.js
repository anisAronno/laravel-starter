import{t}from"./app-PCjOKslU.js";const e=document.querySelector("#btn-trigger-toast"),o=document.querySelector("#btn-trigger-toast-success"),r=document.querySelector("#btn-trigger-toast-danger"),n=document.querySelector("#btn-trigger-toast-warning"),s=document.querySelector("#btn-trigger-toast-info"),a=document.querySelector("#btn-trigger-toast-tr"),i=document.querySelector("#btn-trigger-toast-tl"),c=document.querySelector("#btn-trigger-toast-tc"),g=document.querySelector("#btn-trigger-toast-br"),b=document.querySelector("#btn-trigger-toast-bl"),l=document.querySelector("#btn-trigger-toast-bc"),T=document.querySelector("#btn-trigger-toast-closeable"),u=document.querySelector("#btn-trigger-custom-toast"),d=`
