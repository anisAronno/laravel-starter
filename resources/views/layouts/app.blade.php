...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('dashboard/assets/images/logo-small.svg')}}" type="image/svg+xml" />
        ...
        <a href="/">
          <div class="sidebar-header">
            <div class="sidebar-logo-icon">
              <img src="{{asset('dashboard/assets/images/logo-small.svg')}}" alt="logo" class="h-[45px]" />
            </div>
                  ...
                  <button class="group relative flex items-center gap-x-1.5" type="button">
                    <div class="avatar avatar-circle avatar-indicator avatar-indicator-online">
                      <img
                        ...
                        src="{{asset('dashboard/assets/images/avatar1.png')}}"
                        alt="Avatar 1"
                      />
                    </div>
                  </button>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="mt-4 flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                        <img
                          src="{{asset('dashboard/assets/images/product8.png')}}"
                          alt="product-img"
                  ...
                  <div class="card">
                    <div class="card-body flex flex-col gap-2">
                      ...
                      <div class="flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                        <img
                          src="{{asset('dashboard/assets/images/product7.png')}}"
                          alt="product-img"
                          class="w-20 rounded-primary bg-white p-2 dark:bg-slate-800"
                        />
                        <div class="flex flex-1 flex-col gap-1">
                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="flex items-center gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar1.png')}}" class="avatar-img" alt="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex items-center gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar2.png')}}" class="avatar-img" alt="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex items-center gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar3.png')}}" class="avatar-img" alt="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex items-center gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar4.png')}}" class="avatar-img" alt="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex items-center gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar5.png')}}" class="avatar-img" alt="avatar-img" />
                                </div>
                                <div>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="flex gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar1.png')}}" alt="avatar-img" class="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar2.png')}}" alt="avatar-img" class="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar3.png')}}" alt="avatar-img" class="avatar-img" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="flex gap-2">
                                <div class="avatar avatar-circle">
                                  <img src="{{asset('dashboard/assets/images/avatar4.png')}}" alt="avatar-img" class="avatar-img" />
                                </div>
                                <div>
