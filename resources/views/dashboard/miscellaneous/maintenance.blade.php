...
<html lang="en">
  <head>
    ...
    <title>Maintenance - Admin Toolkit</title>
    <meta
      name="description"
  ...
  <body>
    <div id="app" class="flex min-h-screen w-full items-center justify-center">
      ...
      <main class="flex flex-col items-center gap-y-6 p-4">
        <div class="w-full">
          <h4 class="text-center">Site is Under Maintenance</h4>
          <p class="mt-1 text-center text-sm text-slate-500 dark:text-slate-400">Please check back in sometime.</p>
        </div>

        <a href="{{route('admin.dashboard')}}" class="btn btn-primary" role="button">
          <i width="16" height="16" data-feather="home"></i>
          <span>Back to Home</span>
        </a>

        <svg class="w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500">
          <g id="freepik--background-complete--inject-2">
            ...
            ></path>
            <path
              d="M190.81,106.53a9.58,9.58,0,1,1,11.67-6.86A9.58,9.58,0,0,1,190.81,106.53Z"
              style="fill: #e0e0e0"
            ></path>
            <path
            ...
            <rect
              ...
              height="15.51"
              rx="7.38"
              transform="translate(17.68 247.11) rotate(-60.12)"
              style="fill: #ebebeb"
            ></rect>
            <path
            ...
            <rect
              ...
              height="15.51"
              rx="7.38"
              transform="translate(-33.47 78.19) rotate(-20.52)"
              style="fill: #ebebeb"
            ></rect>
            <path
          ...
          <g id="freepik--Screwdriver--inject-2">
            ...
            <g style="opacity: 0.30000000000000004">
              <rect
                ...
                height="68.49"
                rx="3.3"
                transform="matrix(0.96, 0.28, -0.28, 0.96, 116.98, -1.15)"
              ></rect>
            </g>
            <g style="opacity: 0.30000000000000004">
              <rect
                ...
                height="68.49"
                rx="3.3"
                transform="matrix(0.96, 0.28, -0.28, 0.96, 118.35, -3.84)"
              ></rect>
            </g>
            <g style="opacity: 0.30000000000000004">
              <rect
                ...
                height="68.49"
                rx="3.3"
                transform="translate(119.66 -6.72) rotate(16.49)"
              ></rect>
            </g>
            <path
          ...
          <g id="freepik--Gears--inject-2">
            ...
            ></path>
            <path
              d="M445.82,97.78a9.22,9.22,0,0,1-2.95-.86,9,9,0,0,1-2.77-1.34,18.44,18.44,0,0,1,5.72,2.2Z"
              style="fill: #263238"
            ></path>
          </g>
          <g id="freepik--Character--inject-2">
            ...
            ></path>
            <path
              d="M652.26,154.5c.48,0,18.27.69,12.17,17s-21.27,6.85-21.12,6.37S652.26,154.5,652.26,154.5Z"
              style="fill: #ffbf9d"
            ></path>
            <path
            ...
            ></path>
            <polygon
              points="595.52 74.36 618.03 81.57 613.98 87.22 589.85 78.36 595.52 74.36"
              style="fill: #fff"
            ></polygon>
            <path
            ...
            <path
              ...
              style="fill: #263238"
            ></path>
            <rect x="139.63" y="153.88" width="410.04" height="292.88" rx="14.57" style="fill: #455a64"></rect>
            <path
            ...
            <polygon
              points="304.23 425.1 309.74 434.57 387.31 434.57 392.43 425.1 304.23 425.1"
              style="fill: #263238"
            ></polygon>
            <rect x="158.6" y="173.89" width="371.74" height="238.16" rx="3.27" style="fill: #ebebeb"></rect>
            <polygon
              points="529.95 412.4 158.21 412.4 158.6 191.69 529.95 191.69 529.95 412.4"
              style="fill: #fafafa"
            ></polygon>
            <path
              d="M189.84,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,189.84,183.09Z"
              style="fill: #263238"
            ></path>
            <path
              d="M171.28,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,171.28,183.09Z"
              style="fill: #263238"
            ></path>
            <path
              d="M180.82,183.09a3.06,3.06,0,1,1-3.06-3.21A3.14,3.14,0,0,1,180.82,183.09Z"
              style="fill: #263238"
            ></path>
            <path
            ...
            <g style="opacity: 0.30000000000000004">
              <polygon
                points="370.69 259.26 293.2 307 283.14 324.44 376.16 268.73 370.69 259.26"
                style="fill: #fff"
              ></polygon>
            </g>
            <g style="opacity: 0.30000000000000004">
            ...
            ></path>
            <polygon
              points="590.34 329.74 652.63 352.3 648.99 395.05 580.41 367.4 590.34 329.74"
              style="fill: #ffbf9d"
            ></polygon>
            <path
