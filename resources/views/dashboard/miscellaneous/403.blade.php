...
<html lang="en">
  <head>
    ...
    <title>Not Authorized - Admin Toolkit</title>
    <meta
      name="description"
    ...
    <div id="app" class="flex min-h-screen w-full items-center justify-center">
      ...
      <main>
        <div class="flex flex-col items-center justify-center">
          <p class="text-6xl font-semibold text-primary-500">401</p>
          <p class="card-title mt-2">Opps! Unauthorized!</p>
          <p class="text-xs font-semibold">These are the invalid credentials</p>
          <a href="{{route('admin.dashboard')}}">
            <button class="btn btn-primary mt-8 px-8 py-2">Back to Home</button>
          </a>
        </div>
      </main>
      <!-- Main Content Ends -->
