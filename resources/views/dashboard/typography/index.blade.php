<x-app-layout>
    <!-- Page Title Starts -->
    <x-page-title   header="Typography" />
    <!-- Page Title Ends -->
                            ...
                            <div class="flex w-full flex-col gap-1">
                                ...
                                <div class="max-w-full md:max-w-md">
                                    <p>
                                        ...
                                        mollis, est
                                        non commodo luctus. Duis mollis, est non commodo luctus.Duis mollis, est non
                                        commodo
                                        luctus.
                                    </p>
                                </div>
                            ...
                            <div class="flex w-full flex-col gap-2">
                                ...
                                <div class="max-w-md">
                                    <blockquote class="blockquote"
                                        cite="https://www.brainyquote.com/quotes/bruce_lee_413509">
                                        <p>
                    ...
                    <div class="code-viewer-content">
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex w-full flex-col gap-2">
                                ...
                                <p class="truncate">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam dolorem sit nobis
                                    deleniti,
                                    maiores repudiandae neque facilis quam cupiditate. Aliquid iure quos, suscipit, ad
                                    quibusdam
                                    velit animi odit quo vero molestiae ipsam libero optio eum, esse adipisci
                                    repellendus culpa.
                                    Dolore, fuga, reprehenderit dolorem numquam alias omnis, ex quo impedit similique
                                    aperiam
                                    sequi! Libero, voluptatibus asperiores voluptate obcaecati necessitatibus dolore
                                    consequuntur. Dicta libero nulla sequi doloremque dignissimos tempora perferendis
                                    nostrum
                                    totam commodi consequuntur exercitationem ipsum quaerat deserunt dolorem aliquid
                                    beatae,
                                    excepturi eaque, dolores itaque atque. Necessitatibus eveniet vero excepturi! Ipsum
                                    sunt
                                    reiciendis non consectetur fuga excepturi? Obcaecati quas voluptatibus sequi
                                    reiciendis est
                                    nostrum reprehenderit vitae porro temporibus eveniet ipsam ratione officia, adipisci
                                    placeat, aspernatur magni? Nobis culpa quasi asperiores quos vero? Odio eveniet
                                    doloremque
                                    asperiores repellendus omnis voluptate recusandae! Iure natus magnam incidunt
                                    laboriosam ex
                                    vitae aliquid quidem rem? Animi consectetur nihil ipsa enim porro iusto voluptatum,
                                    labore,
                                    possimus sint sit quas ullam neque. Consequuntur omnis numquam doloremque veniam
                                    quo,
                                    voluptate, repellendus in at illo dolorem cumque! Id delectus non possimus aliquid
                                    cum?
                                    Dolor, asperiores perferendis nostrum enim aliquid fugiat non iste illo accusantium
                                    doloremque atque voluptatum, eos nihil repellat sunt dolores harum culpa sit ea
                                    cupiditate
                    ...
                    <div class="code-viewer-content overflow-auto">
                        <div
                            ...
                            <p>
                                ...
                                headings,
                                lists and more. This ends up being really useful for building application UIs because
                                you
                                spend less time undoing user-agent styles, but when you <em>really are</em> just trying
                                to
                            ...
                            <p>
                                ...
                                blog
                                posts to use the user-agent styles either — you want them to look <em>awesome</em>, not
                                awful.
                            </p>
                            <p>
...
&lt;/article&gt;
                            ...
                            <p>
                                ...
                                <a href="https://github.com/tailwindcss/typography/blob/master/README.md">read the
                                    documentation</a>.
                            </p>
                            <hr />
                            ...
                            <p>
                                ...
                                have to
                                undo the top margin on the second heading because it usually looks better for the
                                headings to
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>
                                        ...
                                        is getting
                                        the spacing between the paragraphs, list item heading, and separate list items
                                        to all make
                                        sense. Pretty tough honestly, you could make a strong argument that you just
                                        shouldn't
                                        write this way.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        ...
                                        wouldn't be a
                                        list if it only had one item, and we really want this to look realistic. That's
                                        why I've
                                        added this second list item so I actually have something to look at when writing
                                        the
                                        styles.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        ...
                                        definitely not
                                        worse, and since I seem to be having no trouble making up arbitrary things to
                                        type, I
                            ...
                            <p>
                                I think most people are going to use <a
                                    href="https://highlightjs.org/">highlight.js</a> or
...
plugins: [],
                            ...
                            <p>
                                ...
                                you do
                                it, but I guess since some of you goofballs are going to do it we have to carry the
                                burden of
                            ...
                            <p>
                                ...
                                repository. I
                                don't love that there is an underline below the backticks but it is absolutely not worth
                                the
                            ...
                            <p>
                                ...
                                can't
                                explain why I want things to end that way but I have to assume it's because I think
                                things
